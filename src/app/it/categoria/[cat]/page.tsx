...
const getMockProducts = (category: string, filters: ProductFilters = {}) => {
  let products = [
    ...
    },
    {
      ...
      brand: 'Google',
      image: 'https://placehold.co/400x400/f5f5f5/171717?text=Pixel+8',
      lowestPrice: 89900,
      currency: 'EUR',
      offerCount: 6,
      inStock: true,
    ...
    },
    {
      ...
      brand: 'Xiaomi',
      image: 'https://placehold.co/400x400/f5f5f5/171717?text=Xiaomi+14',
      lowestPrice: 79900,
      currency: 'EUR',
      offerCount: 10,
      inStock: true,
    ...
    },
    {
      ...
      name: 'OnePlus 12',
      brand: 'OnePlus',
      image: 'https://placehold.co/400x400/f5f5f5/171717?text=OnePlus+12',
      lowestPrice: 69900,
      currency: 'EUR',
      offerCount: 7,
      inStock: true,
    ...
    },
    {
      ...
      brand: 'Nothing',
      image: 'https://placehold.co/400x400/f5f5f5/171717?text=Nothing+2',
      lowestPrice: 54900,
      currency: 'EUR',
      offerCount: 5,
      inStock: true,
